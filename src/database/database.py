...
async def get_redis_key() -> AsyncGenerator[Redis, None]:
    """
...
async def put_session(client: Redis, user_id: int, doc: SessionDoc):
    """
...
async def set_main_metrics(client: Redis, user_id: int, main_metrics: MainMetrics):
    """
...
async def update_income(client: Redis, user_id: int, value: int | None = None, optimized_value: int | None = None):
    """
...
async def update_passengers(client: Redis, user_id: int, value: int | None = None, optimized_value: int | None = None):
    """
...
async def update_avg(client: Redis, user_id: int, value: int | None = None, optimized_value: int | None = None):
    """
...
async def replace_unoptimized_schedule(client: Redis, user_id: int, items: list[ScheduleItem]):
    """
...
async def replace_optimized_schedule(client: Redis, user_id: int, items: list[ScheduleItem]):
    """
...
async def set_iframes(client: Redis, user_id: int, frames: list[Iframe]):
    """
...
async def get_full(client: Redis, user_id: int) -> SessionDoc | None:
    """
...
async def get_main_metrics_only(client: Redis, user_id: int) -> MainMetrics | None:
    """
...
async def sync_ttl_with_expires_at(client: Redis, user_id: int):
    """
